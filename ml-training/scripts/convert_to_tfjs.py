#!/usr/bin/env python3
"""
TensorFlow.js形式への変換スクリプト

学習済みモデルをTensorFlow.js形式に変換し、
フロントエンドのpublic/modelsディレクトリに配置する
"""
...
def convert_model(task_type: str):
    ...
    if not saved_model_path.exists():
        print(f"Error: {saved_model_path} does not exist")
    ...
    # tensorflowjs_converter を使用して変換
    print(f"Converting SavedModel to TF.js format...")
    try:
