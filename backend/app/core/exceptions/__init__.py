...
class NotFoundException(AppException):
    ...
    def __init__(self, message: str = "リソースが見つかりません", detail: Optional[Any] = None):
...
class ForbiddenException(AppException):
    ...
    def __init__(self, message: str = "アクセス権限がありません", detail: Optional[Any] = None):
...
class ConflictException(AppException):
    ...
    def __init__(self, message: str = "リソースが競合しています", detail: Optional[Any] = None):
