...
export const IMMEDIATE_DETECTION_CONFIDENCE = 0.9;
...
export const NEW_MATCH_REARM_MS = 15000; // Allow a fresh coin detection after long-running stale state

// Capture settings
export const SCAN_FPS = 10; // Frames per second for scanning
