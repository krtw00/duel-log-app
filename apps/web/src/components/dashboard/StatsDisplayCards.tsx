    ...
    cards.push(
      {
        ...
        value: `${Math.round(s.playMistakeRate * 100)}%`,
        subtitle: `${s.playMistakes}/${s.totalDuels}`,
        color: '#ff5252',
        icon: (
          <svg
            width="20"
      ...
      },
      {
        ...
        value: `${Math.round(s.playMistakeWinRate * 100)}%`,
        subtitle: `${Math.round(s.playMistakes * s.playMistakeWinRate)}/${s.playMistakes}`,
        color: '#ff8a65',
        icon: (
          <svg
            width="20"
