...
//   api: {
//     get: vi.fn(() => Promise.resolve({ data: [] } as AxiosResponse<any, any, any>)),
//     delete: vi.fn(() => Promise.resolve({} as AxiosResponse<any, any, any>)),
//   },
// }))
...
//     api.get = vi.fn((url) => {
//       if (url === '/duels/') return Promise.resolve({ data: mockDuels, status: 200, statusText: 'OK', headers: {}, config: {} as AxiosRequestConfig, request: {} } as AxiosResponse<any, any, any>)
//       if (url === '/decks/') return Promise.resolve({ data: [], status: 200, statusText: 'OK', headers: {}, config: {} as AxiosRequestConfig, request: {} } as AxiosResponse<any, any, any>)
