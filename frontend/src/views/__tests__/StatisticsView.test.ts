...
//         return Promise.resolve({ data: [{ deck_name: 'Deck A', count: 10 }], status: 200, statusText: 'OK', headers: {}, config: {} as AxiosRequestConfig, request: {} } as AxiosResponse<any, any, any>)
//       }
//       if (url.includes('recent')) {
//         return Promise.resolve({ data: [{ deck_name: 'Deck B', count: 5 }], status: 200, statusText: 'OK', headers: {}, config: {} as AxiosRequestConfig, request: {} } as AxiosResponse<any, any, any>)
//       }
//       if (url.includes('matchup')) {
//         return Promise.resolve({ data: [{ my_deck_name: 'My Deck', opponent_deck_name: 'Opponent Deck', wins: 5, losses: 3, win_rate: 62.5 }], status: 200, statusText: 'OK', headers: {}, config: {} as AxiosRequestConfig, request: {} } as AxiosResponse<any, any, any>)
//       }
//       return Promise.resolve({ data: [], status: 200, statusText: 'OK', headers: {}, config: {} as AxiosRequestConfig, request: {} } as AxiosResponse<any, any, any>)
//     })
//   })
...
//     api.get = vi.fn(() => Promise.resolve({ data: [], status: 200, statusText: 'OK', headers: {}, config: {} as AxiosRequestConfig, request: {} } as AxiosResponse<any, any, any>)) // Mock empty data
