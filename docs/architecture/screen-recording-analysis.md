...
2.  **動的リサイズとキャッシュ**: 読み込んだマスター画像から、ゲームがサポートする全解像度に合わせたテンプレート群を**動的にリサイズ生成**します。対応解像度: 1280x720, 1366x768, 1440x810, 1600x900, 1920x1080, 2048x1152, 2560x1440, 3200x1800, 3840x2160
